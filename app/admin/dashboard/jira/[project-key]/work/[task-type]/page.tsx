...
interface ProjectTaskTypeWorkPageProps {
  params: Promise<{
    "project-key": string;
    "task-type": string;
  }>;
...
export default async function ProjectTaskTypeWorkPage({
  params,
  searchParams,
}: ProjectTaskTypeWorkPageProps) {
    ...
    if (appError.code === "NOT_FOUND") {
      ...
      return (
        <ProjectJiraShell
          ...
          title={`${draft.project.name} ${taskTypeSlug}`}
          description="Focused Jira execution queue."
