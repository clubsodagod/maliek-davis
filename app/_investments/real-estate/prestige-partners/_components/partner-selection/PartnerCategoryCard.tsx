...
import { PartnerCategory } from "../../_library/copy.const";

interface PartnerCategoryCardProps {
    step: PartnerCategory;
    open: boolean;
}

const PartnerCategoryCard: React.FC<PartnerCategoryCardProps> = ({ step, open }) => {
    ...
    useEffect(() => {
        const bulletInterval = setInterval(() => {
            setActiveBullet((prev) => (prev + 1) % step.bullets.length);
            setProgress(0);
        }, DURATION);
